        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-md">
            ...
            <div className="mb-8 text-center">
              ...
              <h1 className="font-serif text-3xl">Đăng ký</h1>
              <p className="mt-2 text-muted-foreground">Tạo tài khoản để bắt đầu mua sắm</p>
            </div>
              ...
              <CardContent className="p-8">
                <form className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="fullname" placeholder="Nguyễn Văn A" className="rounded-full" />
                  </div>
                ...
                <div className="space-y-3">
                  <Button type="button" variant="outline" size="lg" className="w-full rounded-full bg-transparent">
